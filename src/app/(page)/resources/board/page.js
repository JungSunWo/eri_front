                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        !board.categoryCd || board.categoryCd === '' ? 'bg-gray-100 text-gray-800' :
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 md:p-6 w-11/12 sm:w-5/6 md:w-4/5 lg:w-3/4 xl:w-2/3 max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="border-b pb-6 mb-6">
              <div className="flex items-center gap-2 mb-4">
                <span className={`px-2 py-1 text-xs rounded-full ${
                  !selectedBoard.categoryCd || selectedBoard.categoryCd === '' ? 'bg-gray-100 text-gray-800' :
                                           ...
                                           return (
                                             ...
                                             >
                                               ...
                                               <div className="absolute w-full h-full">
                                                                                                  <div
                                                   className={`absolute -top-6 left-1/2 transform -translate-x-1/2 px-2 py-1 text-center ${
                                                     link.style?.outlineShape === 'circle' ? 'rounded-full' :
