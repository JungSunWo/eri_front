...
export default function MenuManagementPage() {
  ...
  const DraggableTreeNode = ({ menu, level = 0, onSelect, onToggle, isSelected, isExpanded, hasChildren }) => {
    ...
    return (
      <div
        ref={setNodeRef}
        className={`flex items-center gap-2 p-2 hover:bg-gray-100 cursor-pointer ${isSelected ? 'bg-blue-100 border-l-4 border-blue-500' : ''
          }`}
        style={{
      ...
      >
        ...
        <div className="flex gap-1">
          ...
          <CmpBadge
            ...
            className={`text-xs ${menu.mnuAuthType === 'COUNSELOR' ? 'border-green-500 text-green-600 bg-green-50' : ''
              }`}
          >
