...
import { ConvertToDataAttributes, FormattedLabel } from './../../utils/utils';
...
const StyledInfoBox = styled.div`
    ...
    .infoBox_toggleIcon{display:block;height:1.6rem;width:1.6rem;transition:all 0.3s;}
...
export { CmpInfoBox, CmpInfoli, CmpOlList, CmpOlListLi, StyledInfoBox };
